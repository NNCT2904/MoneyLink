<template>
  ...
  <div id="Aside">
    ...
    <el-table-column prop="date" align="center" label="Group ID" width="250" />
    <el-table-column prop="amount" align="center" label="Households in this group"  />
    <el-table-column prop="description" align="center" label="Group members" />
  </el-table>
  </div>
  </div>
  </div>
